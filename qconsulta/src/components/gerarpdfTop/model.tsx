...
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>Valor Parcela</Text>
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>Valor Liberado</Text>
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>Saldo Devedor</Text>
//             </View>
//             <View style={styles.tableCol}>
...
//                   {contrato.contrato || "Sem informação"}
//                 </Text>
//               </View>
//               <View style={styles.tableCol}>
//                 <Text style={styles.tableCell}>
...
//               <View style={styles.tableCol}>
//                 <Text style={styles.tableCell}>
//                   {contrato.banco_codigo} {contrato.banco_descricao}
//                 </Text>
//               </View>
//               <View style={styles.tableCol}>
//                 <Text style={styles.tableCell}>
...
//           <View style={styles.tableRow}>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>banco_codigo</Text>
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>banco_descricao
//               </Text>
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>contrato</Text>
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>data_inclusao
//               </Text>
//             </View>
//             <View style={styles.tableCol}>
...
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>tipo_emprestimo</Text>
//             </View>
//             <View style={styles.tableCol}>
//               <Text style={styles.tableCell}>
